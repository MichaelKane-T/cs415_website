    ...
    fetch(process.env.REACT_APP_API_URL_BASE + "/addresses/user/" + user_id)
      ...
      .then((data) => {
        ...
        if (data.useraddress && data.useraddress.length > 0) {
          ...
          setUserAddress(data.useraddress[0].address_1);
          setUserAddress2(data.useraddress[0].address_2);
          setuserZipCode(data.useraddress[0].zip);
          setuserCountry(data.useraddress[0].country);
        }
      })
      .catch((error) => console.error(error));
  }, [navigate, user_id]);
                ...
                <div className="bg-white shadow rounded-lg p-6">
                  ...
                  <div className="flex flex-col">
                    ...
                    <ul>
                      ...
                      <li className="mb-2"> {userAddress}</li>
                      <li className="mb-2"> {userAddress2}</li>
                      <li className="mb-2"> {userZipCode}</li>
                      <li className="mb-2"> {userCountry}</li>
                    </ul>
                  </div>
                </div>
              </div>
